    ...
    return (
      <Box sx={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(135deg, #FFF7F0, #FFE8D6)' }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 6, flexWrap: 'wrap', justifyContent: 'center' }}>
          <Button component={Link} to="/admin/vendors" variant="contained" color="secondary">Manage Vendors</Button>
        ...
        <Grid container spacing={3} sx={{ maxWidth: 900, px: 2 }}>
          {[
            { icon: '🏪', title: 'Vendor Management', text: 'Add, edit, and manage vendors.' },
  ...
  if (token && role === 'ROLE_VENDOR') {
    return (
      <Box sx={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(135deg, #FFF7F0, #FFE8D6)' }}>
        <Typography variant="h3" sx={{ fontWeight: 800, color: 'secondary.main', mb: 2, textAlign: 'center' }}>Welcome to FreshGrocer</Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mb: 4, textAlign: 'center', maxWidth: 600 }}>
          Manage your products, track orders, and grow your business. Your vendor dashboard is ready!
        </Typography>
        <Box sx={{ display: 'flex', gap: 2, mb: 6, flexWrap: 'wrap', justifyContent: 'center' }}>
          <Button component={Link} to="/vendor/dashboard" variant="contained" color="secondary">Vendor Dashboard</Button>
          <Button component={Link} to="/vendor/products" variant="contained" color="primary">Manage Products</Button>
          <Button component={Link} to="/vendor/orders" variant="contained" color="secondary">View Orders</Button>
        </Box>
        <Grid container spacing={3} sx={{ maxWidth: 900, px: 2 }}>
          {[
            { icon: '📦', title: 'Product Management', text: 'Add, edit, and manage your product inventory easily.' },
            { icon: '📊', title: 'Order Tracking', text: 'Track and manage customer orders in real-time.' },
            { icon: '💼', title: 'Business Growth', text: 'Expand your reach and grow your customer base.' }
          ].map((c, i) => (
            <Grid item xs={12} md={4} key={i}>
              <Card variant="outlined">
                <CardContent sx={{ textAlign: 'center' }}>
  ...
  if (token && role === 'ROLE_CUSTOMER') {
    return (
      <Box sx={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(135deg, #FFF7F0, #FFE8D6)' }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, mb: 6, flexWrap: 'wrap', justifyContent: 'center' }}>
          <Button component={Link} to="/vendors" variant="contained" color="secondary">Browse Vendors</Button>
